export default function AboutPage() {
  return (
    <section className="max-w-4xl mx-auto space-y-6">
      ...
      <p className="text-gray-300"> Auto Servis MEDO posluje više od 15 godina i pruža sve vrste popravki i održavanja za putnička i teretna vozila. Naš tim stručnjaka garantuje kvalitetnu uslugu, povjerenje i sigurnost vašeg vozila.</p>
